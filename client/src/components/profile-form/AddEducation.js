...
const AddEducation = ({addEducation, history}) => {
    ...
    return (
      ...
      <p className="lead">
        <i className="fas fa-code-branch"></i> Add any school or bootcamps that you have attended
      </p>
      ...
      <form className="form" 
        ...
        <div className="form-group">
          <textarea
            ...
            cols="30"
            rows="5"
            placeholder="Degree Description" value={description} onChange={e => onChange(e)}
          ></textarea>
        </div>
